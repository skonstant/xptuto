...
namespace djinni {
    ...
    class I64 : public Primitive<I64, int64_t> {
        ...
        static Boxed::ObjcType
        box(CppType x) noexcept { return [NSNumber numberWithLongLong:static_cast<long long>(x)]; }
    };
    ...
    struct Enum {
        ...
        private:
            ...
            static ObjcType fromCpp(CppType x, Tag<int>) noexcept {
                return [NSNumber numberWithInteger:static_cast<NSInteger>(Enum::fromCpp(x))];
            }
            ...
            static ObjcType fromCpp(CppType x, Tag<unsigned>) noexcept {
                return [NSNumber numberWithUnsignedInteger:static_cast<NSUInteger>(Enum::fromCpp(x))];
            }
        };
    };
