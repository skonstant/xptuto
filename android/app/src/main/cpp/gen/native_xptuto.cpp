...
CJNIEXPORT void JNICALL Java_org_example_xptuto_Xptuto_00024CppProxy_native_1getReposForUser(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jobject j_cb)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::xptuto::Xptuto>(nativeRef);
        ref->get_repos_for_user(::djinni_generated::NativeGetReposCb::toCpp(jniEnv, j_cb));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, )
}
